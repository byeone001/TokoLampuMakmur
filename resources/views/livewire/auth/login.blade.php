<div
    ...
    <div class="relative z-10 w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <!-- Form Section -->
            <form class="px-8 py-10 space-y-6" wire:submit.prevent="login">
                <!-- Email/Username Input -->
                <div>
                    <label for="username" class="block text-sm font-medium text-slate-700 mb-2">
                        Email atau Username
                    </label>
                    <input type="text" id="username" wire:model="username" placeholder="nama@example.com atau username"
                ...
                <div class="flex items-center">
                    <input type="checkbox" id="remember"
                        class="w-4 h-4 text-amber-400 rounded focus:ring-2 focus:ring-amber-400">
            ...
            <!-- Links Section -->
            <div class="px-8 pb-8 space-y-4 text-center">
                <a href="/forgot-password"
                    class="block text-sm text-amber-600 hover:text-amber-700 font-semibold transition">
                    Lupa password?
                </a>
